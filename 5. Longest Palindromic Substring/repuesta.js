function longestPalindrome(s) {
    ...
    for (var i = 0; i < N; i++) {
        ...
        var palindromoPar = expandir(s, i, i + 1);
        if (palindromoPar.length > longestStr.length)
            longestStr = palindromoPar;
        var palindromoImpar = expandir(s, i, i);
        if (palindromoImpar.length > longestStr.length)
            longestStr = palindromoImpar;
    }
    return longestStr;
}
var expandir = function (s, l, r) {
